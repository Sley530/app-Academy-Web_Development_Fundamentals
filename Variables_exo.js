...
// Answer I expect that the two fist variable will display successfully,
// but the lost will not.
...
//    expect them to be when they get printed?
//    Answer: Now, I expected that all the variable will print out their 
//    corresponding value.
console.log(firstName);
console.log(lastName);
console.log(age);
